# -*- coding: utf-8 -*-
# Generated by Django 1.11b1 on 2017-05-12 13:11
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('fileKind', models.CharField(choices=[('MV', 'Movie'), ('M3', '3D Movie'), ('MC', 'Movie-Cartoon'), ('MM', 'Mini-movie'), ('CC', 'Concert'), ('DD', 'Documentary'), ('TV', 'TV-show'), ('TC', 'TV-Cartoon'), ('TS', 'TV-Sitcom'), ('MS', 'Mini-series'), ('SG', 'song'), ('PT', 'picture'), ('AB', 'audio-book'), ('EB', 'e-book'), ('GG', 'Game'), ('BR', 'BF-random'), ('UN', 'unknown')], default='UN', max_length=10)),
