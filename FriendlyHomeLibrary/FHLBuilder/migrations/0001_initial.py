# -*- coding: utf-8 -*-
# Generated by Django 1.11b1 on 2017-04-01 16:59
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('fileKind', models.CharField(choices=[('MV', 'Movie'), ('MC', 'Movie-cartoon'), ('CC', 'Concert'), ('DD', 'Documentary'), ('GG', 'Game'), ('TS', 'TV-Sitcom'), ('TD', 'TV-Drama'), ('TC', 'TV-cartoon'), ('TM', 'TV-miniseries'), ('AB', 'audio-book'), ('EB', 'e-book'), ('SG', 'song'), ('UN', 'unknown')], default='UN', max_length=2)),
