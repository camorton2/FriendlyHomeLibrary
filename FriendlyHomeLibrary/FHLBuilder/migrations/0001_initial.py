# -*- coding: utf-8 -*-
# Generated by Django 1.11b1 on 2017-04-22 14:25
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('fileKind', models.CharField(choices=[('UN', 'unknown'), ('MV', 'Movie'), ('MM', 'Mini-movie'), ('CC', 'Concert'), ('DD', 'Documentary'), ('TV', 'TV-show'), ('MS', 'Mini-series'), ('AB', 'audio-book'), ('EB', 'e-book'), ('SG', 'song'), ('PT', 'picture'), ('GG', 'Game')], default='UN', max_length=10)),
