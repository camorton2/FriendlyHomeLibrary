# -*- coding: utf-8 -*-
# Generated by Django 1.11b1 on 2017-06-24 18:34
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('fileKind', models.CharField(choices=[('SG', 'song'), ('PT', 'picture'), ('MV', 'Movie'), ('M3', '3D Movie'), ('MC', 'Movie-Cartoon'), ('MM', 'Mini-movie'), ('CC', 'Concert'), ('DD', 'Documentary'), ('TV', 'TV-show'), ('TC', 'TV-Cartoon'), ('TS', 'TV-Sitcom'), ('MS', 'Mini-series'), ('ST', 'Standup-comedy'), ('BR', 'BF-random'), ('AB', 'audio-book'), ('EB', 'e-book'), ('GG', 'Game'), ('UN', 'unknown')], default='UN', max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('collection', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='books', to='FHLBuilder.Collection')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('commonfile_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='FHLBuilder.CommonFile')),
                ('collection', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='chapters', to='FHLBuilder.Collection')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('commonfile_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='FHLBuilder.CommonFile')),
                ('collection', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='games', to='FHLBuilder.Collection')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('commonfile_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='FHLBuilder.CommonFile')),
                ('collection', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='movies', to='FHLBuilder.Collection')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('artist_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='FHLBuilder.Artist')),
                ('albums', models.ManyToManyField(blank=True, related_name='album_musicians', to='FHLBuilder.Collection')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('data4', models.CharField(blank=True, max_length=1000)),
                ('data5', models.CharField(blank=True, max_length=1000)),
                ('collection', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='pictures', to='FHLBuilder.Collection')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('collection', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='songs', to='FHLBuilder.Collection')),
